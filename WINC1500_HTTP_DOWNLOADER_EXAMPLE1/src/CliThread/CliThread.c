...
static const CLI_Command_Definition_t xDistanceSensorGetDistance = {"getdistance",
                                                                    ...
                                                                    0};
*/
static const CLI_Command_Definition_t xSoilMoistureGetMoisture = {"getMoisture",
								  "getMoisture: Returns the moisture and temperature from the I2C Soil Moisture Sensor.\r\n",
								  (const pdCOMMAND_LINE_CALLBACK)CLI_SoilMoistureGetMoisture,
								  0};
...
static const CLI_Command_Definition_t xMicCommand =
{
	"mic",
	"mic: Read microphone data\r\n",
	(const pdCOMMAND_LINE_CALLBACK)CLI_GetMicData,
	0
};
static const CLI_Command_Definition_t xNPKCommand =
{
	"npk",
	"npk: Get soil NPK (Nitrogen, Phosphorus, Potassium) data\r\n",
	(const pdCOMMAND_LINE_CALLBACK)CLI_NPKSensorGetNPK,
	0
};
...
/**************************************************************************//**
* @fn			BaseType_t CLI_GetMicData( int8_t *pcWriteBuffer,size_t xWriteBufferLen,const int8_t *pcCommandString )
...
/**************************************************************************//**
* @fn			BaseType_t CLI_SoilMoistureGetMoisture( int8_t *pcWriteBuffer,size_t xWriteBufferLen,const int8_t *pcCommandString )
...
/**************************************************************************//**
* @fn			BaseType_t CLI_NPKSensorGetNPK( int8_t *pcWriteBuffer,size_t xWriteBufferLen,const int8_t *pcCommandString )
